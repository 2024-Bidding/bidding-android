...
internal class ItemApi(
    ...
    suspend fun createItem(createItemRequest: CreateItemRequest) =
        runCatching {
    ...
    suspend fun fetchItemDetails(itemId: Long) =
        runCatching {
    ...
    suspend fun likeItem(itemId: Long) =
        runCatching {
            RequestHandler<Unit>().request {
                ktorClient.patch {
